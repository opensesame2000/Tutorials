 ...
 * 2013-09-10T19:00:15.674+05:30
 * Generated source version: 2.7.6
 * 
 */
public final class SimpleService_P1_Client {

    private static final QName SERVICE_NAME = new QName("http://porul.com/ss", "SimpleService");
    ...
    public static void main(String args[]) throws java.lang.Exception {
        ...
        // To intercept via TCPMon on port 8888
        BindingProvider bp = (BindingProvider) port;
        Map<String, Object> context = bp.getRequestContext();
        context.put(BindingProvider.ENDPOINT_ADDRESS_PROPERTY, "http://localhost:8888/ss/p1");
        
        {
        System.out.println("Invoking concat...");
        com.porul.ss.ConcatRequest _concat_parameters = new ConcatRequest();
        
        _concat_parameters.setS1("Hello Service: ");
        _concat_parameters.setS2("From Raj!");
