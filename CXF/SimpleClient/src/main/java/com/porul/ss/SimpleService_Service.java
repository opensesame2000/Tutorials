 ...
 * 2013-09-10T19:00:15.768+05:30
 * Generated source version: 2.7.6
 * 
 */
@WebServiceClient(name = "SimpleService", 
                  wsdlLocation = "src/main/resources/SimpleService.wsdl",
                  targetNamespace = "http://porul.com/ss") 
public class SimpleService_Service extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://porul.com/ss", "SimpleService");
    public final static QName P1 = new QName("http://porul.com/ss", "p1");
    static {
        URL url = SimpleService_Service.class.getResource("src/main/resources/SimpleService.wsdl");
        if (url == null) {
        	//Using the wsdl file under target/classes directory instead as relative paths are not loaded by class loaders
        ...
        if (url == null) {
            java.util.logging.Logger.getLogger(SimpleService_Service.class.getName())
                .log(java.util.logging.Level.INFO, "Can not initialize the default wsdl from {0}", "src/main/resources/SimpleService.wsdl");
        }       
        WSDL_LOCATION = url;
    }
